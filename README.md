...
1. using transform for moving sliding pizzas instead of changing styles.
...
Or I try to zoom the size of pictures or the size of pizza container with transform.scale(), and it did not work out neither.
